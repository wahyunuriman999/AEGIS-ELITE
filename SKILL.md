...
*The AI MUST explicitly output its internal Cognitive BIOS Check and its current Clock Tick (e.g. `[BIOS: OK] [Tick 4: PLAN]`) when replying to the user to prove that the Runtime Pipeline is ALIVE and AUDITABLE.*# HUMAN-FIRST WRITING SYSTEM
